...
- State candidates as CANDIDATE MATCH (per the Match Confidence Rule below) until that GE Admin page confirms name, email, address, and amount together. Once it does, it's CONFIRMED, no further hedging needed.
